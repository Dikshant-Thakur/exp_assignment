...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws_diki_new/install/cpp_ros2_ws"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_ros2_ws/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_ros2_ws/environment/path.sh"
